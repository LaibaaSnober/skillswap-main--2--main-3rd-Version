...
>
  ...
  {!isAuthenticated && (
    <div className="flex justify-center">
      <Link
        to="/register"
        className="bg-white text-brand-plum hover:bg-brand-blush font-semibold text-lg px-10 py-4 rounded-full inline-flex items-center justify-center transition-colors duration-200 shadow-lg transform active:scale-95 hover:scale-105 hover:shadow-2xl"
      >
        Create Your Profile
        <ArrowRight className="w-5 h-5 ml-2" />
      </Link>
